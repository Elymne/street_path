...
class AddReaction extends Usecase<AddReactionParams, bool> {
  ...
  Future<Result<bool>> execute(AddReactionParams params) async {
    try {
      ...
      SpLog().e('AddReaction: Une exception a été levée.', err, stack: stack);
...
class AddReactionParams {
  ...
  final String
  authorName; // todo: Surement fait automatiquement par le usecase si le "authorname" est stocké et géré quelque part.
